...
String key = "JaNdRgUkXp2s5v8y/A?D(G+KbPeShVmY";
...
void setup() {
  ...
  WiFi.mode(WIFI_STA);
  WiFiMulti.addAP("wifichearia", "cheariapass");
...
void loop() {
  ...
  String req_path = "https://api.progettochearia.it/v1/board/putdata/" + dataName;
  Serial.println(body);
